...
const SEARCH_ADDRESS_KEY = 'SEARCH_ADDRESS_KEY';
...
export const SEARCH_ADDRESS = {
  set: (data) => AsyncStorage.setItem(SEARCH_ADDRESS_KEY, JSON.stringify(data)),
  get: () => AsyncStorage.getItem(SEARCH_ADDRESS_KEY).then((data) => (data ? JSON.parse(data) : null)),
  remove: () => AsyncStorage.removeItem(SEARCH_ADDRESS_KEY),
};
