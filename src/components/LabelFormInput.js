...
import { Text, View, StyleSheet, TextInput, Image, Dimensions, ScrollView, Platform } from 'react-native';
            ...
            <View style={
                ...
                <View>
                    ...
                    <Text style={styles.labelText}>{label}</Text>
                    {
                        (type === "text")
                        ? <TextInput
                            style={[styles.textInput, prefixIcon ? {paddingLeft: 40} : {}]}
